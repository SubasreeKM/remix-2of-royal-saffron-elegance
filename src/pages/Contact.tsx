        ...
        <div className="container mx-auto px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 -mt-24 relative z-10">
            {contactInfo.map((info, index) => (
              <div
                key={info.label}
                className="bg-card p-8 rounded-sm shadow-elegant text-center transition-all duration-500 hover:-translate-y-2"
              >
      ...
      <section className="py-24 bg-ivory-dark">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-card p-8 md:p-12 rounded-sm shadow-elegant">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-ivory border border-border rounded-sm focus:outline-none focus:border-gold transition-colors"
                    ...
                    <button
                      ...
                      className={`px-5 py-2.5 text-sm font-medium transition-all duration-300 ${
                        formData.contactMethod === method
                          ...
                          : "bg-ivory border border-border text-foreground hover:border-gold"
                      }`}
                    >
                      {method}
                    </button>
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-ivory border border-border rounded-sm focus:outline-none focus:border-gold transition-colors resize-none"
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-gold text-royal-purple-dark font-semibold text-sm uppercase tracking-widest transition-all duration-300 hover:shadow-gold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
                {isSubmitting ? (
                  <>
                    <div className="w-5 h-5 border-2 border-royal-purple-dark/30 border-t-royal-purple-dark rounded-full animate-spin" />
                    Sending...
                  </>
                ) : (
                  <>
            ...
            <div className="mt-8 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-gold text-royal-purple-dark font-medium text-sm uppercase tracking-wider transition-all duration-300 hover:shadow-gold"
              >
