      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          {products.map((product, index) => (
            <div
              key={product.id}
              className="group relative overflow-hidden bg-card rounded-sm shadow-card transition-all duration-700 hover:shadow-elegant hover:-translate-y-2"
              style={{ animationDelay: `${index * 200}ms` }}
            >
              {/* Tag */}
              <div className="absolute top-4 left-4 z-10">
                <span className="px-4 py-1.5 bg-gold text-royal-purple-dark text-xs font-semibold tracking-wider uppercase">
                  {product.tag}
                </span>
              </div>
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="font-serif text-xl text-royal-purple mb-2 group-hover:text-gold transition-colors">
                  {product.name}
                </h3>
        ...
        <div className="text-center">
          <Link
            to="/products"
            className="inline-flex items-center gap-3 px-8 py-4 bg-royal-purple text-ivory font-sans font-medium text-sm tracking-widest uppercase transition-all duration-300 hover:bg-royal-purple-light hover:shadow-elegant group"
          >
            View All Products
