      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-ivory/50 text-xs uppercase tracking-wider">Secure Payments:</span>
            <div className="flex items-center gap-3">
              {paymentMethods.map((method) => (
                <span 
                  key={method}
                  className="px-3 py-1.5 bg-ivory/10 rounded text-xs font-medium text-ivory/70"
                >
                  {method}
                </span>
              ))}
      ...
      <div className="border-t border-ivory/10 py-5">
        <div className="container mx-auto px-6">
          <p className="text-center text-ivory/50 text-xs tracking-wider">
            © 2024 Z Princess Saffron. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
